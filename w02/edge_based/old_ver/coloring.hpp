...
struct Coloring{
  ...
  Coloring(): color_reord(nullptr), arg_color_reord(),
...
struct Block_coloring{
  ...
  Block_coloring(): numblock(0), bs(0), nedge(0), colornum(nullptr),
  ...
  Block_coloring(int _numblock, int _bs, int *_cnum, vector<vector<int> > _coff,
      int * _reord, int _nedge): numblock(_numblock), bs(_bs), nedge(_nedge),
                                 colornum(_cnum){
