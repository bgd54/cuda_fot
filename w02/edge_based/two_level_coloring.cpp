...
void reorder_data_after_coloring(Block_coloring &bc, Coloring& c,
  ...
  std::vector<int> new_edges(arg_enode.set_size*arg_enode.set_dim);
  std::vector<float> new_eval(arg_edge_val.set_size*arg_edge_val.set_dim);
  std::vector<float> new_nval(arg_node_val.set_size*arg_node_val.set_dim);
